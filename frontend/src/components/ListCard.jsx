...
const ListCard = ({item}) => {
  ...
  return (
    <>
      <div className="listCard mb-2 w-[full] flex items-center justify-between p-[9px] bg-[#141414] cursor-pointer rounded-lg hover:bg-[#202020] ">
...

    {
        ...
        <div className="mainModel w-[25vw] h-[25vh] bg-[#141414] rounded-lg p-[20px]">
            <h3 className='text-3xl'>DO WANT TO DELETE <br /> THIS PROJECT </h3>
